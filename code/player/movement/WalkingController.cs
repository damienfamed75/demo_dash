...
[Library]
public partial class WalkingController : DemoDash.util.BasePlayerController
{
	...
	public BaseDuck Duck;
	public BaseUnstuck Unstuck;


	public WalkingController()
	{
		Duck = new BaseDuck( this );
		Unstuck = new BaseUnstuck( this );
	}
