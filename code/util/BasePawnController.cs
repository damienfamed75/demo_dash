...
namespace DemoDash.util;

public class BasePawnController : BaseNetworkable
{
	...
	public void UpdateFromEntity( Entity entity )
	{
		...
		if ( entity is DemoDashPlayer player )
		{
	...
	public void UpdateFromController( BasePawnController controller )
	{
	...
	public void Finalize( Entity target )
	{
		...
		if ( target is DemoDashPlayer player )
		{
	...
	/// </summary>
	public virtual void RunEvents( BasePawnController additionalController )
	{
